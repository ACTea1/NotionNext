...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一个无业游民, Hi，我是一个打工人,Hi，我是一个干饭人,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '古早茶', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '典型INTJ观察样本', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.ancienteahouse.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '茶壹屋', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'ancienteaa@163.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  WIDGET_PET_SWITCH_THEME: process.env.NEXT_PUBLIC_WIDGET_PET_SWITCH_THEME || fause, // 点击宠物挂件切换博客主题
